...
export default function AppNavigator(){
  return <NavigationContainer>
    <Stack.Navigator initialRouteName="Splash" screenOptions={{headerShown:false,animation:"fade_from_bottom",contentStyle:{backgroundColor:"#F5F9F7"}}}>
      ...
      <Stack.Screen name="AssignDevice" component={AssignDeviceScreen}/>
